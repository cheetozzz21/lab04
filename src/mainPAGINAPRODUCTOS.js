...
function MainProductos() {
    ...
    const productos = [
        { nombre: 'LECHEE GLORIAA', slug: '20.90 ', precio: '20-30', categoria: 'bebidas', imagen: 'https://plazavea.vteximg.com.br/arquivos/ids/28594257-512-512/929548.jpg' },
            ...
            <div className="container">
                <div className="row mt-4">
                    ...
                    <div className="col-md-9">
                        <h4 className="text-right text-center">productos</h4>
                        <hr />
                        <div className="row">
